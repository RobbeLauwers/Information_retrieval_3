...
filenames = [["./data/news_articles_large.csv","./data/news_articles_large_alphanumerical.csv"], ["./data/news_articles_small.csv", "./data/news_articles_small_alphanumerical.csv"]]
